...
- `tadeas-f32-011` · 2026-09-01 · hotovo · Nálad je čtrnáct místo šesti, jsou to kategorie a v Profilu se dají po jedné vypínat. Pilulky jsou mřížka o třech sloupcích místo posouvacího pásu. Výchozí zůstává původních šest. Týž výběr řídí i filtr tipů Co dál na kartě Na cestě.
- `tadeas-f32-010` · 2026-09-01 · hotovo · Počasí na Domů se přepíná lomítkem u tebe / na cestě. Hodinový pruh zůstává vždycky u tvé polohy, dny se řídí tím, kde ten den máš být. Den s víc zastávkami se kopíruje pod sebe a řádky slepí společné podbarvení. Za jízdy se bere rozjetá cesta, jinak plán; celá výprava na jeden dotaz do Open-Meteo.
