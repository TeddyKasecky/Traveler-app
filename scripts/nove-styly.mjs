 ...
 */
export const NOVE_STYLY = ['addform.css', 'pruh.css', 'podklad.css', 'motiv.css', 'profil.css', 'plan-dny.css', 'plan.css', 'kosikFab.css', 'porovnani.css', 'vzory.css', 'mapa.css', 'dialog.css']
