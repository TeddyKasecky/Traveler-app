...
/* ---------- otisk bodů trasy ----------
 *
 * BYDLÍ TADY, protože je to klíč, kterým se geometrie ukládá i hledá – držet
 * ho jinde znamená držet ho dvakrát. Do září 2026 byl ve `views/plan/routing.js`
 * a `map/planLine.js` si ho musela opsat, protože mapa nesmí importovat views.
 * Ta kopie se pak neaktualizovala, když otisk přešel na hash: mapa počítala
 * dlouhý řetězec, uložený byl osmiznakový hash, porovnání nemohlo nikdy vyjít
 * a přepočtená trasa se na hlavní mapě NIKDY nenakreslila. Z `core/` na to
 * dosáhne mapa i views, takže je otisk jeden. */
