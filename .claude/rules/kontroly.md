...
| `check-worker.mjs` | `npm run check-worker` | že Cloudflare Worker nepustí dál, co nemá — název souboru, obsah, kolize, heslo, 45 bodů |
...
| `smoke.mjs` | `npm run smoke` / `smoke:single` | proklikání v prohlížeči, 378 / 339 kontrol |
